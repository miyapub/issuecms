...
if($method==='POST'){
    ...
    if($file!=NULL){
        //uppic
        $sql="UPDATE `issues` SET `pic` = '$file' WHERE `id` = $id;";
    ...
    if($sub_title!=''){
        $sql="UPDATE `issues` SET `sub_title` = '$sub_title' WHERE `id` = $id;";
        mysql_query($sql,$conn);
    }
    ?>
    <script>
                            ...
                            <div class="um-col-1">
                              <div class="um-field um-field-username um-field-text" data-key="title">
                                ...
                                <div class="um-field-area">
                                  <input class="um-form-field valid " type="text" name="title" id="title" value="<?=$title?>" placeholder="标题" data-validate="unique_username" data-key="title">
                                </div>
                              </div>
                              ...
                              <div class="um-field um-field-user_password um-field-password" data-key="sub_title">
                                ...
                                <div class="um-field-area">
                                  <input class="um-form-field valid " type="text" name="sub_title" id="sub_title" value="<?=$sub_title?>" placeholder="副标题" data-validate="" data-key="sub_title">
                                </div>
                              </div>
