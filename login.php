                ...
                <article id="post" class="post page type-page status-publish hentry">
                  <div class="entry-content aesop-entry-content">
                        ...
                        <iframe class="msg" name="msg" style="width: 100%;height: 40px;"></iframe>
                          <form method="post" target="msg" autocomplete="off">
                            ...
                            <div class="um-col-1">
                              <div class="um-field um-field-username um-field-text" data-key="username">
                                <div class="um-field-label">
                                  <label for="username-1477">账户</label>
                                  <div class="um-clear"></div>
                                </div>
                                <div class="um-field-area">
                                  <input class="um-form-field valid " type="text" name="name" id="name" value="" placeholder="" data-validate="unique_username_or_email" data-key="username">
                                </div>
                              </div>
                              
                              <div class="um-field um-field-user_password um-field-password" data-key="user_password">
                                <div class="um-field-label">
                                  <label for="user_password-1477">密码</label>
                                  <div class="um-clear"></div>
                                </div>
                                <div class="um-field-area">
                                  <input class="um-form-field valid " type="password" name="pass" id="pass" value="" placeholder="" data-validate="" data-key="user_password">
                                </div>
                              </div>

                              <div class="um-field um-field-user_password um-field-password" data-key="code">
                                <div class="um-field-label">
                                  <label for="user_password-1477">验证码</label>
                                  <div class="um-clear"></div>
                                </div>
                                <div class="um-field-area">
                                  <img class="code" src="code.php?id=<?=rand()?>" alt="">
                                  <input class="um-form-field valid " type="password" name="code" id="code" value="" placeholder="" data-validate="" data-key="code">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="um-col-alt">
                            ...
                            <div class="um-left um-half">
                              <input type="submit" value="登录" class="um-button">
                            </div>
                            <div class="um-right um-half">
                              <a href="reg.php" class="um-button um-alt">注册</a>
                            </div>			
                            <div class="um-clear"></div>
                          </div>
                          <!--
                          <div class="um-col-alt-b">
                            <a href="password-reset.php" class="um-link-alt">忘记密码？</a>
                          </div>-->
                        </form>
                      </div>
                    </div>
