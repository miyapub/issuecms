...
if($method==='POST'){
    ...
    $avatar=get_up_load_file('avatar');
    $banner=get_up_load_file('banner');
    ...
    if($avatar!=NULL){
      ...
      ?>
      <script>
        window.parent.avatar.src='<?=$avatar?>';
      </script>
      <?
    }

    if($banner!=NULL){
      $sql="UPDATE `users` SET `banner` = '$banner' WHERE `users`.`id` = $user_id;";
      mysql_query($sql,$conn);
      $_SESSION['banner']=$banner;
    }

    if($bio!=NULL){
      $sql="UPDATE `users` SET `bio` = '$bio' WHERE `users`.`id` = $user_id;";
      mysql_query($sql,$conn);
    }
    echo "资料已更新";
    ?>
                        ...
                        <iframe class="msg" name="msg" style="width: 100%;height: 40px;"></iframe>
                            ...
                            <div class="um-col-1">
                              ...
                              <div class="um-field um-field-username um-field-text" data-key="title">
                                <div class="um-field-label">
                                  <label for="username-1477">介绍</label>
                                  <div class="um-clear"></div>
                                </div>
                                <div class="um-field-area">
                                  <input class="um-form-field valid " type="text" name="bio" value="" placeholder="150个字介绍你自己" data-validate="unique_username" data-key="title">
                                </div>
                              </div>
                              
                              <div class="um-field um-field-user_password um-field-password">
                                <div class="um-field-label">
                                  <label for="user_password-1477">头像</label>
                                  <div class="um-clear"></div>
                                </div>
                                <div class="um-field-area">
                                  <input class="um-form-field valid " type="file" name="avatar" />
                                </div>
                              </div>

                              <div class="um-field um-field-user_password um-field-password">
                                <div class="um-field-label">
                                  <label for="user_password-1477">banner</label>
                                  <div class="um-clear"></div>
                                </div>
                                <div class="um-field-area">
                                  <input class="um-form-field valid " type="file" name="banner" />
                                </div>
                              </div>
                          ...
                          <div class="um-col-alt">
                            ...
                            <div class="um-left um-half">
                              <input type="submit" value="更新" class="um-button">
                            </div>
